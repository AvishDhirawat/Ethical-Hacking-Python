...
def build_arg_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument("--lesson-tab-name", default="", help='Text/label of lesson tab (default: "Lesson")')
    parser.add_argument("--notes-tab-name", default="", help='Text/label of notes tab (default: "Notes")')
    parser.add_argument("--practice-tab-name", default="", help='Text/label of practice tab (default: "Practice Test")')
